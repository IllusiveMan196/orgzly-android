...
** IMPR Under-the-hood maintenance and Dropbox compatibility update
:PROPERTIES:
:CUSTOM_ID: e531398
:END:
** IMPR Highlight note when its popup menu is opened
:PROPERTIES:
:CUSTOM_ID: 4a25d87
:END:
** FEAT Global sync progress bar
:PROPERTIES:
:CUSTOM_ID: ebf4fd7
:END:
** FEAT Customizable quick actions
:PROPERTIES:
:CUSTOM_ID: c672b1f
:END:
** FEAT Initial clocking support
:PROPERTIES:
:CUSTOM_ID: 67636c2
:END:
** FEAT Support for org-protocol links (org-id-goto, org-search)
:PROPERTIES:
:CUSTOM_ID: 6259d0f
:END:
* v1.8.10
...
** FEAT Allow using alarm clock for scheduling reminders with a time of day
:PROPERTIES:
:CUSTOM_ID: 8ca22f4
:END:
** FEAT Log and view major events (e.g. scheduling reminders)
:PROPERTIES:
:CUSTOM_ID: 0232ce3
:END:
** FIX Check for reminders since the last run on boot and data-change
:PROPERTIES:
:CUSTOM_ID: 8f9ea2a
:END:
** IMPR Remove edit/view modes from note, single tap to edit and position the cursor correctly
:PROPERTIES:
:CUSTOM_ID: 388b103
:END:
** IMPR Replace quick menus with popup windows
:PROPERTIES:
:CUSTOM_ID: 17b3891
:END:
...
** IMPR Target API 22 (Android 5.1) :beta7:
:PROPERTIES:
:CUSTOM_ID: 45f312d
:END:
